...
def page_login():
    ...
    st.info("Connexion Google en cours...")
...
if menu == "📊 Tableau de bord":
    ...
    st.success(f"Signal IA Global: 🟢 ACHAT | Dernier Score: {st.session_state.history[-1]['Score'] if st.session_state.history else 84}/100")
...
# ============== 8. BACKTESTING ==============
    ...
    st.line_chart(pd.DataFrame({"Capital": np.random.uniform(9000, capital, 100)}))
